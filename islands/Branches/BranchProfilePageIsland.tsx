...
export default function BranchProfilePageIsland() {
  ...
  useEffect(() => {
    ...
    if (storedBranchInfos) {
      console.log("ericão", JSON.parse(storedBranchInfos));
  ...
  return (
    <section className="flex justify-center pb-20 relative mb-[26rem] md:mb-80">
      <div className="max-w-[69.6rem] flex flex-col md:flex-row gap-8 w-full absolute -top-20 px-4">
        <Image
          src={branchInfos?.branchImage || "brasas-sede.webp"}
          alt="Background"
          className="object-cover rounded-3xl md:w-1/2"
        />
        <div className="md:w-1/2 flex flex-col justify-end gap-6 py-4">
          <div className="flex justify-between">
            <div className="flex gap-2">
              ...
              <div className="flex flex-col">
                ...
                <span>
                  {branchInfos?.branchNeighborhood}, {branchInfos?.branchCity},
                  {" "}
                  {branchInfos?.branchState}
                </span>
                <a
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-16">
            ...
            <div className="flex flex-col">
              {branchInfos?.branchTels.map((tel) => (
